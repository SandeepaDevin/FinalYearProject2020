#include "veins_inet/WifiApplication.h"
...
Define_Module(WifiApplication);

WifiApplication::WifiApplication()
{
}

bool WifiApplication::startApplication()
{
...
bool WifiApplication::stopApplication()
{
    return true;
}
...
void WifiApplication::processPacket(std::shared_ptr<inet::Packet> pk)
{
