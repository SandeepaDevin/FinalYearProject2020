...
#include "veins/new/DemoBaseApplLayernew.h"

using namespace veins;

void DemoBaseApplLayernew::initialize(int stage)
{
...
simtime_t DemoBaseApplLayernew::computeAsynchronousSendingTime(simtime_t interval, ChannelType chan)
{
...
void DemoBaseApplLayernew::populateWSM(BaseFrame1609_4* wsm, LAddress::L2Type rcvId, int serial)
{
...
void DemoBaseApplLayernew::receiveSignal(cComponent* source, simsignal_t signalID, cObject* obj, cObject* details)
{
    Enter_Method_Silent();
...
void DemoBaseApplLayernew::handlePositionUpdate(cObject* obj)
{
...
void DemoBaseApplLayernew::handleParkingUpdate(cObject* obj)
{
    isParked = mobility->getParkingState();
}

void DemoBaseApplLayernew::handleLowerMsg(cMessage* msg)
{
...
void DemoBaseApplLayernew::handleSelfMsg(cMessage* msg)
{
    switch (msg->getKind()) {
...
void DemoBaseApplLayernew::finish()
{
...
DemoBaseApplLayernew::~DemoBaseApplLayernew()
{
...
void DemoBaseApplLayernew::startService(Channel channel, int serviceId, std::string serviceDescription)
{
...
void DemoBaseApplLayernew::stopService()
{
    cancelEvent(sendWSAEvt);
    currentOfferedServiceId = -1;
}

void DemoBaseApplLayernew::sendDown(cMessage* msg)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendDown(msg);
}

void DemoBaseApplLayernew::sendUp(cMessage* msg)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendUp(msg);
}
void DemoBaseApplLayernew::sendDelayedDown(cMessage* msg, simtime_t delay)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendDelayedDown(msg, delay);
}

void DemoBaseApplLayernew::checkAndTrackPacket(cMessage* msg)
{
