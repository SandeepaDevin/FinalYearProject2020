...
#include "veins_inet/VeinsInetSampleApplicationnew.h"
...
Define_Module(VeinsInetSampleApplicationnew);

VeinsInetSampleApplicationnew::VeinsInetSampleApplicationnew()
{
}

bool VeinsInetSampleApplicationnew::startApplication()
{
...
bool VeinsInetSampleApplicationnew::stopApplication()
{
    return true;
}
...
void VeinsInetSampleApplicationnew::processPacket(std::shared_ptr<inet::Packet> pk)
{
